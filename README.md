...
Other installations you'd need are the additional libraries, a fully updated list will be in `Project.xml` in the project root.
For each of those type `haxelib install [library]` so shit like `haxelib install newgrounds`
...
## Ok I'm done compiling. What's next?
Nothing get tf out
