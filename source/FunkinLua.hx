...
class FunkinLua
{
	...
	// THIS DOES ABSOLUTELY NOTHING FOR NOW
	function modInsert(beat:Float, len:Float, startPercent:Float, endPercent:Float, modName:String)
	{
		var modArray:Array<String> = ['flip', 'attenuate'];
		lePlayState.mods.push([beat, len, startPercent, endPercent, modName]);
	}
